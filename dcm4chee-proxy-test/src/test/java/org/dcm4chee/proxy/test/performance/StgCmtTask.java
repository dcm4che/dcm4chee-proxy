 ...
 */
    ...
    public class StgCmtTask implements Runnable {
        PrintWriter writer;
        String stgCmtTaskName;
        int stgCmtTaskPort;
        public int getnEventTime() {
            return nEventTime;
        }

        public void setnEventTime(int nEventTime) {
        ...
        public void setAssocTime(int assocTime) {
        ...
        public void run() {
            ...
            try {
                ...
                new StgCmtTestTool(this,device,conn,writer,stgCmtTaskName, Thread.currentThread()
