...
set MAIN_JAR=dcm4chee-proxy-tool-1.0.2.jar
...
set CP=%CP%;%PROXY_HOME%\lib\dcm4chee-proxy-conf-1.0.2.jar
set CP=%CP%;%PROXY_HOME%\lib\dcm4chee-proxy-service-1.0.2.jar
