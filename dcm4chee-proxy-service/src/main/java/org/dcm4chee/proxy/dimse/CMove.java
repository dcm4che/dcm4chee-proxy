...
public class CMove extends DicomService {
    ...
    protected static final Logger LOG = LoggerFactory.getLogger(CMove.class);

    private PIXConsumer pixConsumer;
    private ApplicationEntityCache aeCache;

    public CMove(ApplicationEntityCache aeCache, PIXConsumer pixConsumer, String... sopClasses) {
        super(sopClasses);
    ...
    public void onDimseRQ(Association asAccepted, PresentationContext pc, Dimse dimse, Attributes rq, Attributes data)
        ...
        if (forwardAssociationProperty == null) {
            List<ForwardRule> forwardRules = proxyAEE.filterForwardRulesOnDimseRQ(asAccepted, rq, dimse);
